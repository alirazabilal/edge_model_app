...
import 'main.dart'; // Import your MainHomePage (adjust path if needed)
...
class _LoginScreenState extends State<LoginScreen> {
  ...
  final String hardcodedEmail = "team.com";
  ...
  void _login() {
    if (_emailController.text == hardcodedEmail &&
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(builder: (_) => const MainHomePage()), // ✅ Navigate to your main app
      );
    } else {
